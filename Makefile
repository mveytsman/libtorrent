...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(srcdir)/libtorrent-rasterbar.pc.in \
	$(srcdir)/libtorrent-rasterbar-cmake.pc.in AUTHORS COPYING \
...
ACLOCAL = ${SHELL} /vagrant/libtorrent/libtorrent-rasterbar-1.0.2/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /vagrant/libtorrent/libtorrent-rasterbar-1.0.2/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /vagrant/libtorrent/libtorrent-rasterbar-1.0.2/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /vagrant/libtorrent/libtorrent-rasterbar-1.0.2/build-aux/missing automake-1.14
AWK = gawk
...
COMPILETIME_OPTIONS =  -DTORRENT_USE_OPENSSL  -DWITH_SHIPPED_GEOIP_H  -DBOOST_ASIO_HASH_MAP_BUCKETS=1021  -DBOOST_EXCEPTION_DISABLE  -DBOOST_ASIO_ENABLE_CANCELIO  -DBOOST_ASIO_DYN_LINK -DTORRENT_LINKING_SHARED 
CPP = gcc -E
...
LTLIBICONV = -liconv
LTLIBOBJS = 
MAKEINFO = ${SHELL} /vagrant/libtorrent/libtorrent-rasterbar-1.0.2/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_BUGREPORT = arvid@rasterbar.com
PACKAGE_NAME = libtorrent-rasterbar
PACKAGE_STRING = libtorrent-rasterbar 1.0.2
...
STRIP = strip
VERSION = 1.0.2
abs_builddir = /vagrant/libtorrent/libtorrent-rasterbar-1.0.2
abs_srcdir = /vagrant/libtorrent/libtorrent-rasterbar-1.0.2
abs_top_builddir = /vagrant/libtorrent/libtorrent-rasterbar-1.0.2
abs_top_srcdir = /vagrant/libtorrent/libtorrent-rasterbar-1.0.2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /vagrant/libtorrent/libtorrent-rasterbar-1.0.2/build-aux/install-sh
